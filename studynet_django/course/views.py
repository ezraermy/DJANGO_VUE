...
from .models import Course, Comment, Lesson, Category
...
def add_comment(request, course_slug, lesson_slug):
    ...
    comment = Comment.objects.create(course=course, lesson=lesson, name=name, content=content, create_by=request.user)
